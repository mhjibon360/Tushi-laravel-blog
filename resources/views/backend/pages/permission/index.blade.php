    ...
    <div class="pd-ltr-20 xs-pd-20-10">
        <div class="min-height-200px">
            <div class="page-header">
                <div class="row">
                    ...
                    <div class="col-md-6 col-sm-12 text-right">
                        <a class="btn btn-primary" href="{{ route('admin.permission.create') }}">
                            Create New
                        </a>
            ...
            <div class="card-box mb-30">
                <div class="pd-20">
                    <h4 class="text-blue h4">All Permission List</h4>
                </div>
                <div class="pb-20">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <table class="data-table table  nowrap dataTable no-footer dtr-inline"
                                    id="DataTables_Table_1" permission="grid" aria-describedby="DataTables_Table_1_info">
                                    <thead>
                                        <tr permission="row">
                                            <th class="table-plus datatable-nosort sorting_asc" rowspan="1"
                                                colspan="1" aria-label="Name">Si</th>
                                            <th class="table-plus datatable-nosort sorting_asc" rowspan="1"
                                                colspan="1" aria-label="Name">Permission Group</th>
                                            <th class="table-plus datatable-nosort sorting_asc" rowspan="1"
                                                colspan="1" aria-label="Name">Permission Name</th>
                                    ...
                                    <tbody>
                                        @foreach ($allpermission as $item)
                                            <tr permission="row" class="odd">
                                                ...
                                                <td class=" text-capitalize">{{ $item->group_name }}</td>
                                                <td >{{ $item->name }}</td>
                                                <td>
                                                    <div class="table-actions">
                                                        ...
                                                        <form class="ml-2 d-inline"
                                                            action="{{ route('admin.permission.destroy', $item->id) }}"
                                                            method="post">
                                                            @csrf
                                                            @method('DELETE')
