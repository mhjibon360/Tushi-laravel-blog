...
@section('title', 'all contact message list')
@section('content')
    @push('admin_style')
    ...
    <div class="pd-ltr-20 xs-pd-20-10">
        <div class="min-height-200px">
            ...
            <div class="card-box mb-30">
                <div class="pd-20">
                    <h4 class="text-blue h4">All Contact-Message List</h4>
                </div>
                <div class="pb-20">
                                ...
                                <table class="data-table table  nowrap dataTable no-footer dtr-inline"
                                    ...
                                    <thead>
                                        <tr role="row">
                                            ...
                                            <th class="table-plus datatable-nosort sorting_asc" rowspan="1"
                                                colspan="1" aria-label="Name">Message</th>
                                            <th class="table-plus datatable-nosort sorting_asc" rowspan="1"
                                                colspan="1" aria-label="Name">Time</th>
                                            <th class="table-plus datatable-nosort sorting_asc" rowspan="1"
                                                colspan="1" aria-label="Name">Actions</th>
                                                ...
                                                <td>
                                                    <div class="table-actions">
                                                        ...
                                                        <form class="ml-2 d-inline"
                                                            action="{{ route('admin.delete.contact.list', $item->id) }}"
                                                            method="post">
                                                            @csrf
                                                            @method('DELETE')
