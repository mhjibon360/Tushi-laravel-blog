...
@section('title', 'all language list')
@section('content')
    @push('admin_style')
    ...
    <div class="pd-ltr-20 xs-pd-20-10">
        <div class="min-height-200px">
            ...
            <div class="card-box mb-30">
                <div class="pd-20">
                    <h4 class="text-blue h4">All language List</h4>
                </div>
                <div class="pb-20">
                                ...
                                <table
                                    ...
                                    <thead>
                                        <tr role="row">
                                            ...
                                            <th class="table-plus datatable-nosort sorting_asc" rowspan="1"
                                                colspan="1" aria-label="Name">language Name</th>
                                            <th class="table-plus datatable-nosort sorting_asc" rowspan="1"
                                                colspan="1" aria-label="Name">language Short Code</th>
                                            <th class="sorting" tabindex="0" aria-controls="DataTables_Table_1"
                                                rowspan="1" colspan="1"
                                                aria-label="Salart: activate to sort column ascending">Salart</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                                ...
                                                <td>
                                                    <div class="table-actions">
                                                        ...
                                                        <form class="ml-2 d-inline"
                                                            action="{{ route('admin.language.destroy', $item->id) }}"
                                                            method="post">
                                                            @csrf
                                                            @method('DELETE')
