                                        ...
                                        <li class="weight-500 col-md-12">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea id="summernote" name="details" class="form-control form-control-lg @error('details') is-invalid @enderror"
                                                    type="text" rows="4">{{ old('details') }}</textarea>
                                                @error('details')
                                                    <small class=" text-danger">{{ $message }}</small>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <br>
                                                    <input type="checkbox" id="post_name" value="1" name="featured"
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <br>
                                                    <input type="checkbox" id="post_of_the_month" value="1"
                                                        name="post_of_the_month" class="switch-btn" data-size="small"
                                                        data-color="#f56767" />
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="checkbox" id="status" value="1" name="status"
                                                        class="switch-btn" data-size="small" data-color="#a683eb" />
                                                </div>
                                            </div>
                                        </div>
