    ...
    <div class="pd-ltr-20 xs-pd-20-10">
        <div class="min-height-200px">
            ...
            <div class="card-box mb-30">
                <div class="pd-20">
                    <h4 class="text-blue h4">All Role List</h4>
                </div>
                <div class="pb-20">
                    <div id="DataTables_Table_1_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
                        <div class="row">
                            <div class="col-sm-12">
                                <table class="data-table table   dataTable no-footer dtr-inline"
                                    ...
                                    <thead>
                                        <tr role="row">
                                            ...
                                            <th class="table-plus datatable-nosort sorting_asc" rowspan="1"
                                                colspan="1" aria-label="Name">Role Name</th>
                                            <th class="table-plus datatable-nosort sorting_asc" rowspan="1"
                                                colspan="1" aria-label="Name">Access permission</th>
                                            ...
                                            <tr role="row" class="odd">
                                                ...
                                                <td class=" text-capitalize">
                                                    ...
                                                    @foreach ($item->permissions as $perm)
                                                        <span class=" badge badge-primary m-1">{{ $perm->name }}</span>
                                                    @endforeach
                                                </td>
                                                <td>
