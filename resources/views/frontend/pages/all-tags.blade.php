        ...
        <div class="container">
            <div class="row gy-2 align-items-center section-title mb-0 section pt-0">
                <div class="col-12">
                    ...
                    <h1 class="h3 mb-0 title">{{ $tag->tag_name }}</h1>
                </div>
                <div class="col-12">
                    <ul class="list-inline breadcrumb-menu">
                        ...
                        <li class="list-inline-item">• &nbsp; <a class="text-link" href="javascript:;">tag</a>
                        </li>
                        <li class="list-inline-item">• &nbsp; <a class="text-link"
                                href="javascript:;">{{ $tag->tag_name }}</a>
                        </li>
                    </ul>
                </div>
            </div>
