    ...
    <section class="section">
        <div class="container">
            <div class="row gy-2 align-items-center section-title mb-0 section pt-0">
                <div class="col-12">
                    <p class="mb-3">Showing posts from</p>
                    <h1 class="h3 mb-0 title">{{ $category->category_name }}</h1>
                </div>
                <div class="col-12">
                    <ul class="list-inline breadcrumb-menu">
                        ...
                        <li class="list-inline-item">• &nbsp; <a class="text-link" href="categories.html">Categories</a>
                        </li>
                        <li class="list-inline-item">• &nbsp; <a class="text-link"
                                href="javascript:;">{{ $category->category_name }}</a>
                        </li>
                    </ul>
                </div>
            </div>
                                ...
                                <div class="flex-shrink-0">
                                    <a class='is-hoverable' href='{{ route('post.author',$post->author->username) }}'
                                        ...
                                        <img loading="lazy" class="rounded-circle w-auto"
                                            src="{{ asset($post->author->profile) }}" alt="{{ $post->author->username }}" width="42"
                                            height="42">
                                    </a>
                                </div>
